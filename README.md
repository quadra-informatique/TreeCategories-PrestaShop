# TreeCategories for PrestaShop

This PrestaShop module allows you to display categories and sub-categories are displayed in a tree form in the back office
